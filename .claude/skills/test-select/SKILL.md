...
| Changed file(s) | Run |
|-----------------|-----|
| `config/settings.py` only | Full suite — settings affect everything (includes `tests/test_settings_credentials.py`) |
...
| Any file in `host/` | `tests/test_host.py tests/test_tools_outputs.py tests/test_app_ui.py tests/test_entrypoints.py` |
